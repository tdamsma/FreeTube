    ...
    >
      <div class="videoAreaMargin">
        <ft-shaka-video-player
          ...
          :current-playback-rate="channelPlaybackRate ?? currentPlaybackRate"
          :channel-playback-rate="channelPlaybackRate"
          ...
          @toggle-channel-playback-rate="toggleChannelPlaybackRate"
